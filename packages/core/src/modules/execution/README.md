...
**Purpose:** Execution bounded context within the VedMoulya domain model. Provides domain entities, value objects, use cases, infrastructure adapters, and presentation contracts for the execution domain.
